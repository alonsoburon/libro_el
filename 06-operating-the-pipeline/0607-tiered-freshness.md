...
- Tiered freshness is the scheduling implementation of the SLA tiers defined in [[06-operating-the-pipeline/0603-sla-management|0603]]
- Hot-tier extractions must respect source system concurrency limits (see [[06-operating-the-pipeline/0606-source-system-etiquette|0606]])
- Cold-tier full replaces are natural backfill opportunities (see [[06-operating-the-pipeline/0610-backfill-strategies|0610]])
...
## Related Patterns
- [[06-operating-the-pipeline/0603-sla-management|0603-sla-management]] -- SLA tiers define freshness requirements; tiered freshness implements them
- [[06-operating-the-pipeline/0605-scheduling-and-dependencies|0605-scheduling-and-dependencies]] -- schedule structure and safe hours
- [[06-operating-the-pipeline/0602-cost-monitoring|0602-cost-monitoring]] -- tiered freshness is partly a cost optimization strategy
