...
### Date-Range Rebuild
- Reload only the corruption window via backfill (see [[06-operating-the-pipeline/0610-backfill-strategies|0610]])
...
- [ ] Run the rebuild
- [ ] Reconcile post-rebuild (see [[06-operating-the-pipeline/0613-reconciliation-patterns|0613]])
...
- Schema contracts catch drift before it corrupts data (see [[06-operating-the-pipeline/0608-data-contracts|0608]])
- Reconciliation catches silent count/value drift (see [[06-operating-the-pipeline/0613-reconciliation-patterns|0613]])
...
- [[06-operating-the-pipeline/0608-data-contracts|0608-data-contracts]] -- contracts catch the drift before it becomes corruption
- [[06-operating-the-pipeline/0610-backfill-strategies|0610-backfill-strategies]] -- the mechanism for rebuilding a date range
- [[06-operating-the-pipeline/0613-reconciliation-patterns|0613-reconciliation-patterns]] -- post-rebuild verification
- [[06-operating-the-pipeline/0611-partial-failure-recovery|0611-partial-failure-recovery]] -- when corruption is caused by a partial failure
