...
- Feeds into [[06-operating-the-pipeline/0610-extraction-status-gates|0610]] for inline enforcement
...
### Freshness Contract
- Maximum acceptable staleness per table -- the SLA from [[06-operating-the-pipeline/0604-sla-management|0604]] expressed as a contract

## Enforcement Points

### Pre-Load (Gate)
- Check schema, row count, and null rates after extraction, before loading
- If the contract is violated, block the load and alert (see [[06-operating-the-pipeline/0605-alerting-and-notifications|0605]])
- This is the extraction status gate from [[06-operating-the-pipeline/0610-extraction-status-gates|0610]] extended with richer checks
