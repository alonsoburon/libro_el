...
- Tables above a configurable row count threshold should be automatically deferred to the safe window (see [[06-operating-the-pipeline/0605-scheduling-and-dependencies|0605]])
...
- When a query times out, fail the table explicitly (see [[06-operating-the-pipeline/0609-extraction-status-gates|0609]]); don't retry immediately
...
- [[06-operating-the-pipeline/0605-scheduling-and-dependencies|0605-scheduling-and-dependencies]] -- safe hours and massive table thresholds
- [[06-operating-the-pipeline/0609-extraction-status-gates|0609-extraction-status-gates]] -- timeout handling and explicit failure
